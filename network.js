        ...
        "rowCallback": function( row, data, index )
        {
             ...
             if(lastQuery > 0)
             {
                 ...
                 if(diff <= 86400)
                 {
                     ...
                     // The commented-out values are the original value and were replaced as they do not work well in dark mode
		     var ratio = 1e0*diff/86400;
                     //var lightgreen = [0xE7, 0xFF, 0xDE];
                     //the colors above are 231, 255, 222
		     //var lightyellow = [0xFF, 0xFF, 0xDF];
                     //the color above is 255, 255, 223
		     var lightgreen = [0x3D, 0x55, 0x34];
		     //the color above is 61,78,52
		     var lightyellow = [0x55, 0x55, 0x35];
		     //the color above is 85,85,53
		     color = rgbToHex(mixColors(ratio, lightgreen, lightyellow));
                 ...
                 else
                 {
                     ...
                     // Color: light-orange
                     //color = "#FFEDD9";
		     //the color above is 25,237,217
		     color = "#4B3925";
		     //the color above is 75,57,37
                     mark = "<strong>?</strong>";
                 }
             }
             else
             {
                 ...
                 //color = "#FFBFAA";
		 //the color above is 255,191,170
		 color = "#551500";
		 //the color above is 85,21,0
                 mark = "&#x2718;";
             }
