...
$(document).ready(function() {
    ...
    //set the color used in the code described in the next comment below
    var color = "#1A2226";
	...
	//make sure that all cells have the correct background color
	//without this line rgb(249) stripes happen every second row
	//$(color).css("background-color", color);
	//$("td:eq(7)", color).html(mark);
